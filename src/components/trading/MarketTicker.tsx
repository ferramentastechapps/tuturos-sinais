...
export const MarketTicker = () => {
  ...
  return (
    <div className="h-8 sm:h-10 bg-secondary/30 border-b border-border overflow-hidden">
      <div className="flex items-center h-full animate-ticker whitespace-nowrap">
        {duplicatedPairs.map((pair, index) => (
          <div
            ...
            className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-6 border-r border-border/50"
          >
