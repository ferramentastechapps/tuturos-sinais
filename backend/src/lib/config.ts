...
export const config = {
    ...
    monitoredSymbols: (process.env.MONITORED_SYMBOLS || 
        'BTCUSDT,ETHUSDT,SOLUSDT,BNBUSDT,XRPUSDT,DOGEUSDT,ADAUSDT,AVAXUSDT,DOTUSDT,LINKUSDT,MATICUSDT,NEARUSDT,ATOMUSDT,LTCUSDT,BCHUSDT,APTUSDT,SUIUSDT,INJUSDT,OPUSDT,ARBUSDT,RNDRUSDT,FETUSDT,GALAUSDT,SANDUSDT,AXSUSDT,SHIBUSDT,PEPEUSDT,WIFUSDT,FLOKIUSDT,BONKUSDT,TIAUSDT,SEIUSDT,FTMUSDT,AAVEUSDT,UNIUSDT,MKRUSDT,STXUSDT,RENDERUSDT,TAOUSDT,JUPUSDT'
    ).split(','),
} as const;
